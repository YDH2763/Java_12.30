		...
		<div className="container">
			...
			<form onSubmit={submit}>
				...
				<div className="mb-3 mt-3">
					...
					<input type="password" className="form-control" id="pw" placeholder="비번을 입력하세요." value={data.me_pw} name="me_pw" onChange={change}/>
				</div>
				<div className="mb-3 mt-3">
					<label htmlFor="pw2" className="form-label">비번확인:</label>
					<input type="password" className="form-control" id="pw2" placeholder="비번을 확인하세요." value={data.me_pw2} name="me_pw2" onChange={change}/>
				</div>
				<div className="mb-3 mt-3">
