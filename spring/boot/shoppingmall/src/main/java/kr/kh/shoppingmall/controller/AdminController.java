...
public class AdminController {
	...
	public String product(Model model,@PathVariable int ca_num) {
		...
		List<CategoryVO> categoriList = productService.getCategory();
		model.addAttribute("productList", productList);
		model.addAttribute("categoriList", categoriList);
	...
	public String productDeletePost(@PathVariable int pr_code, @PathVariable int ca_num) {
