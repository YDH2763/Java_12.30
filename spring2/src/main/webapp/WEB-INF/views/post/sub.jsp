	...
	<c:forEach items="${list}" var="post">
		<div class="form-group">
			<div class="form-control input-group" style="min-height:auto; height:auto">
				...
				<img width="100" height="120" src="https://www.dailysecu.com/news/photo/202104/123449_145665_1147.png">
				<div class="ml-3">
					...
					<div>추천수 : ${post.po_pu}</div>
				</div>
			</div>			
		</div>		
	</c:forEach>
	<c:if test="${list.size() eq 0 }">
		<div class="form-control text-center">등록ㄷ한 개시글이 없습니다.</div>
	</c:if>
	<!-- 더보기 버튼을 추가 -->
	<c:if test="${pm.next}">
		<button class="btn btn-dangerm but-more col-12"> 더보기 </button>	
	</c:if>
