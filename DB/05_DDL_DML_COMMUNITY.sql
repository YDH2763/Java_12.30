...
테이블명 : BOARD
 ...
 - 제목은 최대 50자, 내용은 긴 문장(문자열), 작성자는 최대 15자
...
CREATE TABLE IF NOT EXISTS BOARD(
	CB_KEY INT PRIMARY KEY AUTO_INCREMENT,
	CB_TITLE VARCHAR(50) NOT NULL,
	CB_CONTENT LONGTEXT NOT NULL,
	CB_USER VARCHAR(15) NOT NULL,
    CB_DATE DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- DELETE FROM BOARD WHERE CB_USER = "abc123" AND CB_KEY = 1;

# 2025년 2월 25일에 작성된 게시글을 조회하는 쿼리 
SELECT * FROM BOARD WHERE CB_DATE BETWEEN "2025-02-25" AND "2025-02-25 23:59:59";
