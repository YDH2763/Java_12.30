...
public class Ex15_Chaining {
	...
	public static void main(String[] args) {
		...
		p.print1();
		System.out.println("------------");
		//print2는 리턴이 Point4 객체이어서 Point4에서 제공하는 메소드를 이어서 체이닝할 수 있음
		p.print2().print1();
		System.out.println("------------");
		//print2sms 리턴이 Point4 객체이어서 Point4에서 제공하는 메소드를 이어서 체이닝할 수 있었고,
		//toString은 리턴이 String이어서 String에서 제공하는 subString을 채이닝으로 사용할 수 있다.
